...
Cypress.config();
describe('Test multiple applications deployment based on clusterGroup', { tags: '@p1_2'}, () => {
...
describe('Test single application deployment based on clusterGroup', { tags: '@p1_2'}, () => {
  const value = 'value_prod'
  let repoName
