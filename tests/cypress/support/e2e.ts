...
declare global {
  ...
  namespace Cypress {
    interface Chainable {
      ...
      addHelmOp(local: boolean, repoName: string, repoUrl: string, chart: string, version?: string, values?: string, deployTo?: string, serviceAccountName?: string, targetNamespace?: string, helmAuth?: string): Chainable<Element>;
    }
  }
}
